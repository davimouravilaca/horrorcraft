...
<div class="form-section">
    <form action="edit_script.php" method="post">
        ...
        <div class="button-group">
            ...
            <!-- Botão "Excluir" agora está ao lado do botão "Salvar" dentro do mesmo formulário -->
            <button class="btn-red" type="submit" name="excluir" onclick="return confirm('Tem certeza que deseja excluir este conto para sempre?');">Excluir</button>
        </div>
    </form>
</div>
